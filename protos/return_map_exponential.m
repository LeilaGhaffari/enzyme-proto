% calculation of stress and deformation tensors, 
% and other constitutive variables

function [stress_el,isv_el,Fp_el] = element_stress_isv(coordsx,d,params,...
    isv_el_n,Fp_el_n,theta)
